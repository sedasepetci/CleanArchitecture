...
public sealed class AuthService : IAuthService
{
    ...
    public async Task<LoginCommandResponse> LoginAsync(CreateNewTokenByRefreshCommand request,CancellationToken cancellationToken)
    {
        User? user = await _userManager.Users
            .Where(p =>p.UserName == request.UserNameOrEmail 
